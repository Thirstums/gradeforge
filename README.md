...
Open http://localhost:3000. On first launch a selection screen blocks until you pick a grading system; your choice persists in the browser and seeds a small set of example grades. Everything runs client-side — there is no server, no database, and no data ever leaves your browser.
